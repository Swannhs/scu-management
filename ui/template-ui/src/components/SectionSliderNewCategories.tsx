                ...
                <div className={`relative flow-root`} {...handlers}>
                    ...
                    {currentIndex ? (
                        <PrevBtn
                            ...
                            className="w-9 h-9 xl:w-12 xl:h-12 text-lg absolute -left-3 xl:-left-6 top-1/3 -translate-y-1/2 z-10"
                        />
                    ) : null}
                    ...
                    {categories.length > currentIndex + numberOfItems ? (
                        <NextBtn
                            style={{transform: "translate3d(0, 0, 0)"}}
                            onClick={() => changeItemId(currentIndex + 1)}
                            className="w-9 h-9 xl:w-12 xl:h-12 text-lg absolute -right-3 xl:-right-6 top-1/3 -translate-y-1/2 z-10"
                        />
                    ) : null}
                </div>
            </MotionConfig>
