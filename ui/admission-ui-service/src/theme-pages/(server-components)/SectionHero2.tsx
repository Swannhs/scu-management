...
import HeroRealEstateSearchForm from "../(client-components)/(HeroSearchForm)/HeroRealEstateSearchForm";
        ...
        <div className={`nc-SectionHero2 relative ${className}`}>
            ...
            <div className="relative py-14 lg:py-20">
                <div className="relative inline-flex">
                    ...
                    <div
                        className="relative max-w-3xl inline-flex flex-shrink-0 flex-col items-start py-16 sm:py-20 lg:py-24 space-y-8 sm:space-y-10 text-white">
                        {children ? (
                            children
                        ) : (
